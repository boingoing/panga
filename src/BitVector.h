...
public:
     ...
     * @param bits_to_compare Limit comparision to only the first bits_to_compare bits.
     */
     ...
     * @param bit_index Starting bit index in the BitVector at which to fetch the integer.
     ...
     * @param bit_index Starting bit index in the BitVector at which to store the integer.
     ...
     * @param destination_start_bit_offset Bit index into destination where we will start writing.
     * @param source_start_bit_offset Bit index into this where we will start copying.
...
protected:
     ...
     * Note: Does not change the value of any existing bits currently in the vector.
     */
    ...
    /**
     * Copy |bits_to_copy| bits from a byte buffer |source| into |destination|.<br/>
     * |source_start_bit_offset| and |destination_start_bit_offset| are bit offsets into |source| and |destination|.<br/>
...
public:
    ...
    struct HexFormat_t {
        friend HexFormatWrapper operator<<(std::ostream& out, const HexFormat_t& manip);
    };
